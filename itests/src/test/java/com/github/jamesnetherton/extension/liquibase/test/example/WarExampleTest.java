...
public class WarExampleTest extends LiquibaseTestSupport {
    ...
    public static Archive<?> deployment() {
        WebArchive archive = ShrinkWrap.createFromZipFile(WebArchive.class, new File("target/examples/wildfly-liquibase-example-war.war"));
        archive.delete("WEB-INF/create-person-table-changelog.xml");
        return archive;
    }
