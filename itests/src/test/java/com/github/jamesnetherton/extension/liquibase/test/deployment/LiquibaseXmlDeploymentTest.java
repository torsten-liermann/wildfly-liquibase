...
public class LiquibaseXmlDeploymentTest extends LiquibaseTestSupport {
    ...
    public static Archive<?> deployment() {
        return ShrinkWrap.create(JavaArchive.class, "liquibase-xml-deployment-test.jar");
    }

    @Test
    public void testXmlDeployment() throws Exception {
