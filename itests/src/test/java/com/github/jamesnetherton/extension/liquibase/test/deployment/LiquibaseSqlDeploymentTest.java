...
public class LiquibaseSqlDeploymentTest extends LiquibaseTestSupport{

    @ChangeLogDefinition(format = "sql")
    private String tableName;

    @Deployment
    public static Archive<?> deployment() {
        return ShrinkWrap.create(JavaArchive.class, "liquibase-sql-deployment-test.jar");
    }

    @Test
    public void testSqlDeployment() throws Exception {
