...
public class LiquibaseJarClasspathDeploymentTest extends LiquibaseTestSupport {
    ...
    public static Archive<?> deployment() {
        return ShrinkWrap.create(JavaArchive.class, "liquibase-jar-classpath-deployment-test.jar");
    }
