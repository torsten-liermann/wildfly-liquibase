...
public class LiquibaseJarRootDeploymentTest extends LiquibaseTestSupport {
    ...
    public static Archive<?> deployment() {
        return ShrinkWrap.create(JavaArchive.class, "liquibase-jar-root-deployment-test.jar");
    }

    @Test
    public void testJarDeploymentRootResource() throws Exception {
