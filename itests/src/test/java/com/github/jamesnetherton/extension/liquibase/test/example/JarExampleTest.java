...
public class JarExampleTest extends LiquibaseTestSupport {
    ...
    public static Archive<?> deployment() {
        JavaArchive archive = ShrinkWrap.createFromZipFile(JavaArchive.class, new File("target/examples/wildfly-liquibase-example-jar.jar"));
        archive.delete("META-INF/create-person-table-changelog.xml");
        return archive;
    }
