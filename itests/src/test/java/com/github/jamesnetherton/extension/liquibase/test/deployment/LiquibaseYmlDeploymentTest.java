...
public class LiquibaseYmlDeploymentTest extends LiquibaseTestSupport {

    @ChangeLogDefinition(format = "yml")
    private String tableName;

    @Deployment
    public static Archive<?> deployment() {
        return ShrinkWrap.create(JavaArchive.class, "liquibase-yml-deployment-test.jar");
    }

    @Test
    public void testYmlDeployment() throws Exception {
