...
public class LiquibaseJsonDeploymentTest extends LiquibaseTestSupport{

    @ChangeLogDefinition(format = "json")
    private String tableName;

    @Deployment
    public static Archive<?> deployment() {
        return ShrinkWrap.create(JavaArchive.class, "liquibase-json-deployment-test.jar");
    }

    @Test
    public void testJsonDeployment() throws Exception {
