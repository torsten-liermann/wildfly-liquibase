...
public class LiquibaseConfigIncludeAllRelativeToChangeLogTest extends LiquibaseTestSupport {
    ...
    @Test
    public void testConfigIncludeAllRelativeToChangeLog() throws Exception {
        assertTableModified("include_all_relative_test");
    }
}
