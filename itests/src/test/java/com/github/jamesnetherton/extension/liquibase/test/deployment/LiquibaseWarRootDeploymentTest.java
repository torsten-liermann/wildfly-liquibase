...
public class LiquibaseWarRootDeploymentTest extends LiquibaseTestSupport {
    ...
    public static Archive<?> deployment() {
        return ShrinkWrap.create(WebArchive.class, "liquibase-war-root-deployment-test.war");
    }
